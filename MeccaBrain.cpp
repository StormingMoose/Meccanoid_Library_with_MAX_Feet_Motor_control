...
void MeccaBrain :: wheel(int wheelNum, byte direction){
...
//
//  chainfrontmotors(pin number you picked to wire to)
//
//  in your program give your motor a name and number like
//
//   LFront = 0;
//
//   later to change its color to red and get it going forward
//   
//    chainfrontmotors.wheel(lfront, 0xE1);
//    communicate();
//    chainfrontmotors.wheel(lfront,0x25);    //  how to keep it going, well, hmm not got that nailed down, but loops work kinda
//    communicate();
//
//
